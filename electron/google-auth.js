...
const CLIENT_ID = '369497685727-f5cks78vr252dv0nfjoekne0qj6k6t86.apps.googleusercontent.com';
const CLIENT_SECRET = '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';
  ...
  return new Promise((resolve) => {
    ...
    const server = http.createServer(async (req, res) => {
      try {
        ...
        if (!code) return;
        res.end('<html><body style="font-family:system-ui;padding:48px;background:#121311;color:#ecede9"><h2 style="margin:0 0 12px">✓ Google Calendar connected</h2><p style="color:#9a9c95;margin:0">You can close this tab and go back to Lumen.</p></body></html>');
        server.close();
